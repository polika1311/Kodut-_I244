...
<ul id ="menu">
  ...
  <li ><a href="Galery.php">Galerii</a></li>
  <li><a href="Pilt1.php">Esimene pilt</a> </li>
  <li><a href="Pilt2.php">Teine pilt</a> </li>
  <li> <a href="Sisselogimine.php">Siselogimine</a></li>
  <li>  <a href="registreerimine.php">Registreerimine</a></li>
  <li>  <a href="Ules.php">Üleslaadimine</a></li>
  </ul>
  </div>
<div class="sisu">
<div id="tekst">
<a href = Galery.php>
<h1 style=color:green;>Galerii</h1>
</a>
...
<p><em> Jupiter </em> koosneb peamiselt heeliumist, mis moodustab Jupiteri massist ühe neljandiku, kõigist molekulidest moodustavad heeliumi molekulid aga vaid kümnendiku. Jupiteril võib olla raskematest elementidest tuum,[3] kuid nagu kõigil hiidplaneetidel, puudub ka Jupiteril tahke pind. Kiire pöörlemise tõttu on Jupiter lapik sferoid. Jupiteri välimine atmosfäär on silmanähtavalt jaotunud vastavalt laiuskraadidele erinevateks kihtideks, mille piirialadel esineb turbulentsi ja torme. Üks tähelepänuväärsemaid Jupiteri atmosfäärinähtusi on Suur Punane Laik, mis on olnud olemas juba vähemalt 17. sajandist, mil seda vaadeldi esmakordselt teleskoobiga. Jupiteri ümbritseb tugev magnetväli ja palja silmaga nähtamatu rõngaste süsteem. Jupiteril on vähemalt 67 kaaslast, sealhulgas neli suurt kaaslast, mille avastas 1610. aastal Galileo Galilei. Neist kõige suurema, Ganymedese läbimõõt on suurem kui Merkuuril.
</p>
<br/>

<a href="http://www.w3schools.com/" target="_blank">Wikipeedia</a>
<br>

	<img id="img1" src="img/Jupiter.jpg" alt="Jupiter" width="250" height="250" >

<h2>Mass ja suurus</h2> 
<br/>
<p style=font-family;sans-šerif;>
Jupiteri mass on 2,5 korda suurem kui kõigi teiste Päikesesüsteemi planeetide kogumass. See tähendab, et Jupiteri 
ja Päikese massikese asub väljaspool Päikest. Jupiteri kõrval on Maa imeväike, kuid märkimisväärselt suurema tihedusega.
 Jupiteri ruumala on 1321 korda suurem kui Maa ruumala, kuid selle mass on vaid 318 korda suurem. Jupiteri raadius on
  umbes kümnendik Päikese raadiusest[11] ja selle mass on umbes 0,001 Päikese massi, seega on Päike ja Jupiter sarnase 
  tihedusega.
<h3>Möödalennumissioonid</h3>
<br/>
<ul>
	<li>Pioneer 10  3. detsember 1973   </li>
	<li>Pioneer 11  4. detsember 1974   </li>
	</ul>
